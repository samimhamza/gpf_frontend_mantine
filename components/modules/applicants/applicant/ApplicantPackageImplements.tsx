...
import {
	CREATE_PACKAGE_IMPLEMENTS,
	DELETE_PACKAGE_IMPLEMENTS,
	...
	return (
		<>
			<CustomDataTable
				...
				setEdit={setEdit}
				showAdd={
					checkPermission(CREATE_PACKAGE_IMPLEMENTS) && isImplementAvailable()
				}
				showDelete={checkPermission(DELETE_PACKAGE_IMPLEMENTS)}
				showEdit={checkPermission(UPDATE_PACKAGE_IMPLEMENTS)}
				showView={false}
				height={300}
